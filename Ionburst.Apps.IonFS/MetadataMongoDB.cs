...
namespace Ionburst.Apps.IonFS
{
    public class MetadataMongoDB : IIonFSMetadata
    {
        ...
        public MetadataMongoDB(string databaseName, string repoName)
        {
        ...
        public async Task<IonFSMetadata> GetMetadata(IonFSObject file)
        {
            ...
            {
                throw new Exception($"MongoDB error occurred. Exception: {e.ToString()}");
            }
            catch (Exception e)
            {
        ...
        public async Task<bool> Exists(IonFSObject fso)
        {
            ...
            {
                Console.WriteLine($"MongoDB error occurred. Exception: {e.ToString()}");
            }
            catch (Exception e)
            {
                Console.WriteLine($"MetdataMongoDB.Exists exception: {e.ToString()}");
            }
        ...
        public async Task<List<IonFSObject>> List(IonFSObject folder, bool recursive = false)
        {
            ...
            {
                Console.WriteLine($"MetadataMongoDB exception: {e.ToString()}");
            }
        ...
        public async Task MakeDir(IonFSObject folder)
        {
            ...
            {
                Console.WriteLine($"MetadataMongoDB.MakeDir exception: {e.ToString()}");
            }
        }
        ...
        public async Task Move(IonFSObject source, IonFSObject target)
        {
            ...
            {
                Console.WriteLine($"MetadataMongoDB.Move exception:  {e.ToString()}");
            }
        }
        ...
        public async Task PutMetadata(IonFSMetadata metadata, IonFSObject folder)
        {
            ...
            {
                Console.WriteLine($"MetadataMongoDB.PutMetadata exception:  {e.ToString()}");
            }
        }
        ...
        public async Task DelMetadata(IonFSObject fSObject)
        {
            ...
            {
                Console.WriteLine($"MetadataMongoDB.DelMetadata exception:  {e.ToString()}");
            }
        }
    }
}
